...
const Section6 = (props: Props) => {
  return (
    <div className="m-auto items-center p-20 flex flex-col gap-8 bg-[#F3F1F7] text-black">
      <div className="lg:flex gap-4 ">
        <div className="w-full lg:w-[736px] flex flex-col gap-2  rounded-2xl pt-10  items-left justify-center overflow-hidden p-10">
          ...
          <span className="w-[485px] text-left flex flex-col gap-2 ">
            <h1 className="font-[Avenir-Heavy] text-[40px] ">
          ...
          <div className="mb-[-40px]  gap-4 bg-[#FBDFD2] p-20 flex items-center justify-center">
            <Image src="/ui/GGG.webp" width={389} height={322} alt="UI1" />
          </div>
        </div>
