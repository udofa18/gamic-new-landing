...
const Section4 = (props: Props) => {
  return (
    <div className="m-auto items-center lg:p-20 py-4 flex flex-col gap-8 bg-[#F6F8FA] text-black ">
      ...
      <div className="flex lg:flex-row flex-col gap-4 lg:p-10 p-2 w-full  items-center justify-center   ">
        <div className="bg-[#EEF1D7] lg:w-[736px] w-full rounded-2xl p-10 overflow-clip pb-0  lg:h-[544px] ">
          ...
          <img src="/ui/wallet.svg"  alt="UI1" className="m-auto  lg:w-[585px] lg:h-[640] h-full w-full"/>
        </div>

        <div className="w-full lg:w-[521px] bg-[#FBE2B7] rounded-2xl flex flex-col items-center justify-center p-5  lg:h-[544px] ">
          <p className="font-[Avenir-Medium] lg:text-2xl text-xl lg:w-[347px] w-full  p-5">Your Wallet, Your ControlManage your assets securely with self-custodial wallets</p>
          <div className="p-5">
            <img
              src="/ui/fomo.svg"
              alt="UI1"
              className="lg:w-[297px] w-[200px]"
            />
          </div>
        </div>
      </div>
      <div className="flex gap-4 p-4 lg:flex-row flex-col lg:h-[552px] h-full justify-center w-full m-auto">
        ...
        <div className="w-full lg:w-[736px] bg-[#DDD7F1]  lg:h-[552px] h-full  rounded-2xl p-4  lg:px-10 px-4 pb-0 flex lg:flex-row flex-col items-center justify-center  lg:h-[544px]  ">
          <div className="">
            <img
              src="/ui/swap.svg" 
              alt="UI1"
