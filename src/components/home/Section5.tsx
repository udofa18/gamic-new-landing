...
const Section5 = (props: Props) => {
  return (
    <div className="m-auto items-center lg:p-20  flex flex-col gap-8 bg-[#F6F8FA] text-black  h-full">
      ...
      <div className="flex lg:flex-row flex-col gap-4 lg:h-[552px] h-full">
