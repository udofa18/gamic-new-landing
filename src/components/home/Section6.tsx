    ...
    <div className="m-auto items-center lg:p-20 p-5 flex flex-col gap-8 bg-[#F3F1F7] text-black ">
      <div className="flex lg:flex-row flex-col gap-4 ">
        <div className="w-full lg:w-[736px] flex flex-col gap-2  rounded-2xl pt-10  items-left justify-center overflow-hidden lg:p-10 p-2">
          <motion.div className="flex px-2 gap-2 border rounded-full border-[#2A799B]  text-[#2A799B] bg-[#2A799B0D]/5 w-[fit-content] text-[14px] items-center"
          ...
          <motion.div className="lg:w-[485px] w-full text-left flex flex-col gap-2 "
            initial="hiddenLeft"
            whileInView="visible"
