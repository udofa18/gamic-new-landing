        ...
        <div className='absolute inset-1 bg-opacity-50  bg-black  z-20'onClick={onClose}>
            ...
            <button onClick={onClose} className=" bg-[#FFFFFF1A] rounded-lg p-3 px-4 align-end"><AiOutlineClose /> </button>
                ...
                <div className="flex justify-around">
                 <Link href="https://play.google.com/store/apps/details?id=app.gamic.guild.gamic_guild_mobile" target='_blank' >  <button ><Image src="/icons/ios.svg" width={150} height={50} alt="aux3" />
                    </button></Link>
                    <Link href="https://apps.apple.com/us/app/gamic-spaces-chat-connect/id1673683070" target='_blank' >        <button ><Image src="/icons/play.svg" width={150} height={50} alt="aux3" />
                    </button>       </Link>         </div>
            </div>
        </div>
    );
